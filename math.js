const levels = [
    { questionImage: '1.png', head: 'level 1' , hint:  '<h3>Hint:</h3> Multiply', 
    solution: '<h3>Solution:</h3> 3*5=15.', answer: '15' },
    { questionImage: '2.png', head: 'level 2' , hint: '<h3>Hint:</h3> All possible ways!',
     solution: '<h3>Solution:</h3> 14', answer: '14' },
    { questionImage: '3.png', head: 'level 3' , hint: ' <h3>Hint:</h3> 10  , 70',  
     solution: "<h3>Solution:</h3> A=70 ,B=10.<br> A/B = 7." , answer: '7' },
    { questionImage: '4.png', head: 'level 4' , hint: '<h3>Hint:</h3> Multiply', 
    solution: '<h3>Solution:</h3> 7', answer: '7' },
    { questionImage: '5.png', hint: '<h3>Hint:</h3> 1 <sup>x</sup>', head: 'level 5' ,
     solution: '<h3>Solution:</h3> 1 <sup>x</sup> = 1. ', answer: '1' },
    { questionImage: '6.png', hint: '<h3>Hint:</h3> Multiples of 7', head: 'level 6' ,
    solution: '<h3>Solution:</h3> 63', answer: '63' } ,
    { questionImage: '7.png', hint: '<h3>Hint:</h3> 2 <sup>n</sup> + 1', head: 'level 7' ,
    solution: '<h3>Solution:</h3> 2 <sup>3</sup> + 1 = 9 <br> 2 <sup>4</sup> + 1 = 17  <br>........<br> 2 <sup>6</sup> + 1 = 65 ', answer: '65' },
    { questionImage: '8.png', hint: '<h3>Hint:</h3> All possible ways', head: 'level 8' ,
     solution: '<h3>Solution:</h3> 13 ', answer: '13' },
    { questionImage: '9.png', hint: '<h3>Hint:</h3> ↓ = → ', head: 'level 9' ,
     solution: '<h3>Solution:</h3> 5+14 = 10+9 <br> 8+7 = 13+2 <br> 7+ <u><b>7</b></u> = 9+5 <br> Ans: 7. ', answer: '7' },
    { questionImage: '10.png', hint: '<h3>Hint:</h3> divide by 4 ', head: 'level 10' ,
     solution: '<h3>Solution:</h3> (15+9)/4 = 6', answer: '6' },
    { questionImage: '11.png', hint: '<h3>Hint:</h3>  A-B = ↓', head: 'level 11' ,
     solution: '<h3>Solution:</h3> 30 -3 = 27.', answer: '27' },
    { questionImage: '12.png', hint: '<h3>Hint:</h3> Multiple. <br> To get opposites', head: 'level 12' ,
     solution: '<h3>Solution:</h3> 13 * 3 = 39. <br> 21 * 3 = 63. <br> 8*3 = 24. <br> Ans: 3. ', answer: '3' },
    { questionImage: '13.png', hint: '<h3>Hint:</h3> x <sup>0</sup> = 1.', head: 'level 13' ,
     solution: '<h3>Solution:</h3> 12', answer: '12' },
    { questionImage: '14.jpg', hint: '<h3>Hint:</h3> Common difference', head: 'level 14' ,
     solution: '<h3>Solution:</h3> 21, 28, 35, 42. <br> Ans:35.', answer: '35' } ,
    { questionImage: '15.png', hint: '<h3>Hint:</h3> + and /', head: 'level 15' ,
    solution: '<h3>Solution:</h3> (21 + 7)/2= 14 <br> (19  + 7)/2 = 13', answer: '13' },
    { questionImage: '16.png', hint: '<h3>Hint:</h3> Multiply the oppposites', head: 'level 16' ,
    solution: '<h3>Solution:</h3> 12*4 = 48', answer: '48' },
    { questionImage: '17.png', hint: '<h3>Hint:</h3> Multiply', head: 'level 17' ,
    solution: '<h3>Solution:</h3> 24', answer: '4' },
   { questionImage: '18.png', hint: '<h3>Hint:</h3> 0 <sup>x</sup> = 0', head: 'level 18' ,
    solution: '<h3>Solution:</h3> 0/x = 0.', answer: '0' } ,
   { questionImage: '19.png', hint: '<h3>Hint:</h3> Multiply and Add', head: 'level 19' ,
   solution: '<h3>Solution:</h3> (9*3) + (2*6) = 39. <br> (4*5) + (4*2) = 28. <br> Ans: 28.', answer: '28' },
   { questionImage: '20.png', hint: '<h3>Hint:</h3> (A - B)<sup>2</sup>', head: 'level 20' ,
